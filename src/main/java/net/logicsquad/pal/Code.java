...
public class Code {
	 ...
	 *            be zero.
	 * @param second
	 *            An <code>Object</code> representing the second argument to the
	 *            instruction. This argument is represented as an
	 *            <code>Object</code> because the actual type can be integer,
	 ...
	 * 
	 * @return An <code>int</code> representing the first argument to this
	 *         instruction.
	 */
	public int getFirst() {
		return first;
	 ...
	 * 
	 * @return An <code>Object</code> representing the second argument to this
	 *         instruction.
	 * @see Code#Code
	 */
	...
	/**
	 * Returns the line number in the source file where this instruction
	 * originated.
	 * 
